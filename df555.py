            ...
            if (data_len == len(req_data) / 2):
                if (data_type == "01" or data_type == "02"):
                    if (data_len == 34):
                        ...
                        data_time_stamp = int(req_data[42:50], 16)
                        ...
                        if(data_len == 42):
                            ...
                            data_time_stamp = int(req_data[58:66], 16)
                            # print("rsrp is "+str(data_rsrp))
                            attribute = {
                                "height": data_height,
                                "gpsEnabled": data_gps_enabled,
                                "longitude": data_longitude,
                                "latitude": data_latitude,
                                "temperature": data_temperature,
                                "heightAlarm": data_empty_alarm,
                                "batteryAlarm": data_battery_alarm,
                                "volt": data_volt,
                                "rsrp": data_rsrp,
                                "frameCounter": data_frame_counter,
                                "timeStamp": data_time_stamp
...
if __name__ == "__main__":
    try:
        attr_result = ""
        incomingData = "80000503330202020A1E4B0F14600456077004020002000047.104.191.39;1990;159.138.4.6;7788;186437604696736981"
        attr_result = DF555.parse_data_DF555(incomingData)
    except Exception as e:
        print(e)